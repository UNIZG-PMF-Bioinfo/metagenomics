...
topGenes <- which(res$padj < 0.05, arr.ind = T)
```
...
#data(demo.paths)
pv <- pathview(gene.data = dt[topGenes, ], pathway.id = demo.paths$sel.paths[3], species = "ko")
pv <- pathview(gene.data = dt[topGenes, ], pathway.id = ???, species = "ko")
```



Kako znam koji pathway.id trebam?
